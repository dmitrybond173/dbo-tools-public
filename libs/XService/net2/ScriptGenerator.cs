...
namespace XService.Components
{
    ...
    {
        /// <summary>Construct ScriptGenerator object from specified XML element</summary>
        /// <param name="pDomNode">XML element with tempplates definitions, expect set of <Template /> elements there</param>
        ...
        /// <summary>Construct ScriptGenerator object as child of other ScriptGenerator object </summary>
        ...
        /// <summary>Parent ScriptGenerator object</summary>
        public ScriptGenerator Parent { get; protected set; }
        /// <summary>Current text of generated script</summary>
        ...
        /// <summary>Ret to active script template object</summary>
        public Template CurrentTemplate { get; protected set; }

        /// <summary>Path to active script template objecr (in case when hierarchy of ScriptGenerator objects used)</summary>
        ...
        /// <summary>Delegate to be called when expanding macro values</summary>
        public delegate bool GetMacroValueMethod(string pTemplate, int pRecLevel, string pPrmName, out object pValue);

        /// <summary>[deprecated] This old method which should expand specified macro value (here is wrong name of property!)</summary>
        public GetMacroValueMethod OnGetMactoValue { get; set; } // <- deprecated
        /// <summary>This old method which should expand specified macro value</summary>
        public GetMacroValueMethod OnGetMacroValue { get; set; }

        /// <summary>Find and return script templayte object by specified name</summary>
        ...
        /// <summary>Count items in specified IEnumerable container</summary>
        ...
        /// <summary>Holder of script template for ScriptGenerator</summary>
        public class Template
        {
            ...
            /// <summary>Holder of script template item</summary>
